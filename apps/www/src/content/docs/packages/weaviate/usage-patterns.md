...
Placeholder: explain what @anvia/weaviate owns and what should stay in application code.

## Common composition

Placeholder: show which runtime, provider, adapter, or tool packages usually appear beside @anvia/weaviate.
