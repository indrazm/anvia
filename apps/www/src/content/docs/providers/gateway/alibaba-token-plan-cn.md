...
description: "Use Alibaba Token Plan (China) through @anvia/openai."
section: providers
sidebar:
  group: LLM Gateway
  order: 1009
...
| API URL | https://token-plan.cn-beijing.maas.aliyuncs.com/compatible-mode/v1 |
| Environment | `ALIBABA_TOKEN_PLAN_API_KEY` |
| Provider docs | [https://www.alibabacloud.com/help/zh/model-studio/token-plan-overview](https://www.alibabacloud.com/help/zh/model-studio/token-plan-overview) |
| Models | 18 |
