...
description: "Use MiniMax (minimax.io) through @anvia/anthropic."
section: providers
sidebar:
  group: LLM Gateway
  order: 1069
...
| Provider docs | [https://platform.minimax.io/docs/guides/quickstart](https://platform.minimax.io/docs/guides/quickstart) |
| Models | 7 |
