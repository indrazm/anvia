---
title: "Zhipu AI"
description: "Use Zhipu AI through @anvia/openai."
section: providers
sidebar:
  group: LLM Gateway
  order: 1142
...
| Tools | 13 / 13 models |
| Structured output | 2 / 13 models |
| Reasoning | 13 / 13 models |
| Temperature | 13 / 13 models |
| Open weights | 10 / 13 models |
...
| `glm-5`<br />GLM-5 | glm | text | text | tools, reasoning, temperature, open weights | context: 204800 / output: 131072 | input: 1 / output: 3.2 / cache_read: 0.2 / cache_write: 0 | 2026-02-11 |
| `glm-5.1`<br />GLM-5.1 | glm | text | text | tools, schema, reasoning, temperature | context: 200000 / output: 131072 | input: 6 / output: 24 / cache_read: 1.3 / cache_write: 0 | 2026-03-27 |
| `glm-5.2`<br />GLM-5.2 | glm | text | text | tools, schema, reasoning, temperature | context: 1000000 / output: 131072 | input: 1.4 / output: 4.4 / cache_read: 0.26 / cache_write: 0 | 2026-06-13 |
| `glm-5v-turbo`<br />GLM-5V-Turbo | glm | image, pdf, text, video | text | tools, reasoning, temperature | context: 200000 / output: 131072 | input: 5 / output: 22 / cache_read: 1.2 / cache_write: 0 | 2026-04-01 |
