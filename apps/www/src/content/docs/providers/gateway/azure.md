---
title: "Azure"
description: "Review Azure connection details and model capabilities."
section: providers
sidebar:
  group: LLM Gateway
  order: 1016
...
| Attachments | 49 / 108 models |
| Tools | 75 / 108 models |
| Structured output | 23 / 108 models |
| Reasoning | 52 / 108 models |
| Temperature | 70 / 108 models |
| Open weights | 43 / 108 models |
...
| `deepseek-v4-flash`<br />DeepSeek-V4-Flash | deepseek-flash | text | text | schema, reasoning, temperature, open weights | context: 1000000 / output: 384000 | input: 0.19 / output: 0.51 | 2026-04-24 |
| `deepseek-v4-pro`<br />DeepSeek-V4-Pro | deepseek-thinking | text | text | schema, reasoning, temperature, open weights | context: 1000000 / output: 384000 | input: 1.74 / output: 3.48 | 2026-04-24 |
...
| `gpt-5.3-chat`<br />GPT-5.3 Chat | gpt-codex | image, text | text | tools, schema, reasoning | context: 128000 / output: 16384 | input: 1.75 / output: 14 / cache_read: 0.175 | 2026-03-03 |
...
| `gpt-image-1`<br />GPT-Image-1 | gpt-image | image, text | image | - | context: 0 / output: 0 | input: 5 / output: 40 / cache_read: 1.25 | 2025-04-24 |
| `gpt-image-1.5`<br />GPT-Image-1.5 | gpt-image | image, text | image, text | - | context: 0 / output: 0 | input: 5 / output: 32 / cache_read: 1.25 | 2025-11-25 |
| `gpt-image-2`<br />GPT-Image-2 | gpt-image | image, text | image | - | context: 0 / output: 0 | input: 5 / output: 30 / cache_read: 1.25 | 2026-04-21 |
| `grok-4-1-fast-non-reasoning`<br />Grok 4.1 Fast (Non-Reasoning) | grok | image, text | text | tools, temperature | context: 128000 / input: 128000 / output: 8192 | input: 0.2 / output: 0.5 / cache_read: 0.05 | 2025-06-27 |
| `grok-4-1-fast-reasoning`<br />Grok 4.1 Fast (Reasoning) | grok | image, text | text | tools, reasoning, temperature | context: 128000 / input: 128000 / output: 8192 | input: 0.2 / output: 0.5 / cache_read: 0.05 | 2025-06-27 |
| `grok-4-20-non-reasoning`<br />Grok 4.20 (Non-Reasoning) | grok | text | text | tools, temperature | context: 262000 / output: 8192 | input: 2 / output: 6 | 2026-04-08 |
| `grok-4-20-reasoning`<br />Grok 4.20 (Reasoning) | grok | text | text | tools, reasoning, temperature | context: 262000 / output: 8192 | input: 2 / output: 6 | 2026-04-08 |
...
| `kimi-k2.5`<br />Kimi K2.5 | kimi-k2 | image, text | text | tools, schema, reasoning, temperature, open weights | context: 262144 / output: 262144 | input: 0.6 / output: 3 | 2026-02-06 |
| `kimi-k2.6`<br />Kimi K2.6 | kimi-k2 | image, text | text | tools, schema, reasoning, temperature, open weights | context: 262144 / output: 262144 | input: 0.95 / output: 4 | 2026-04-22 |
