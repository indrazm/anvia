...
description: "Use Alibaba Coding Plan (China) through @anvia/openai."
section: providers
sidebar:
  group: LLM Gateway
  order: 1007
...
| Provider docs | [https://help.aliyun.com/zh/model-studio/coding-plan](https://help.aliyun.com/zh/model-studio/coding-plan) |
| Models | 12 |
...
| `kimi-k2.5`<br />Kimi K2.5 | kimi-k2 | image, text | text | tools, reasoning, temperature, open weights | context: 262144 / output: 32768 | input: 0 / output: 0 / cache_read: 0 / cache_write: 0 | 2026-01-27 |
| `MiniMax-M2.5` | minimax | text | text | tools, reasoning, temperature, open weights | context: 196608 / output: 24576 | input: 0 / output: 0 / cache_read: 0 / cache_write: 0 | 2026-02-12 |
...
| `qwen3.5-plus`<br />Qwen3.5 Plus | qwen | image, text | text | tools, reasoning, temperature | context: 1000000 / output: 65536 | input: 0 / output: 0 / cache_read: 0 / cache_write: 0 | 2026-02-16 |
