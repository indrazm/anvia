---
title: "Mistral text call"
description: "Run a text call with the Mistral provider package."
section: examples
sidebar:
...
This placeholder reserves the route and menu entry for a future recipe: run a text call with the Mistral provider package.

## Planned ingredients

The final recipe should cover @anvia/mistral setup, model creation, prompt input, response handling.
