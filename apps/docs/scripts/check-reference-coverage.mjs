...
const packageDocs = new Map([
  ...
  ["@anvia/weaviate", "apps/docs/content/docs/reference/integrations/weaviate.mdx"],
  ["@anvia/redis", "apps/docs/content/docs/reference/integrations/redis.mdx"],
  ["@anvia/lancedb", "apps/docs/content/docs/reference/integrations/lancedb.mdx"],
