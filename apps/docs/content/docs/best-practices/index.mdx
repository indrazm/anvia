...
| Need | Pattern |
| --- | --- |
| Use OpenAI, Anthropic, Gemini, Mistral, or gateway models in one app | [Multi-provider Setup](/docs/best-practices/model-patterns/multi-provider-setup) |

## Sandbox Patterns

| Need | Pattern |
| --- | --- |
| Run agent file and command workflows inside a bounded workspace | [Sandbox Best Practices](/docs/best-practices/sandbox-patterns/sandbox-best-practices) |
