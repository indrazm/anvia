...
Add approval policies to protected tools, then register the built agent in Studio:
...
Add Hono route tests in [Setup Tests](/docs/frameworks/hono/10-setup-tests). Core concepts: [Human in the Loop](/docs/guides/human-in-the-loop), [Hook Approval Requests](/docs/guides/human-in-the-loop/tool-approval), [Approval Handlers](/docs/guides/human-in-the-loop/approval-handlers), and [Studio Tool Approvals](/docs/studio/human-in-the-loop/tool-approvals).
